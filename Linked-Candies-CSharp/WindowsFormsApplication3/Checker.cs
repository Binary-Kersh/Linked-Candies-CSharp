...
namespace WindowsFormsApplication3
{
    class Checker
    {
        ...
        public bool CheckAll(Candy root, int ok2)
        {
            bool ok = false;
        ...
        public void change(Candy first, Candy second, int ok2)
        {
        ...
        public void Bomball(HashSet<Candy> Bomber, int ok2)
        {
            ...
            //  MessageBox.Show(ok2 + "32222222222222222222");
            if (ok2 != 0)
            {
